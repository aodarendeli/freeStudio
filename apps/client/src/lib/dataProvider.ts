 ...
 * bağlayan tek implementasyon. Yeni bir kaynak (örn. products) eklediğinde
 * burada hiçbir değişiklik gerekmiyor — sadece resource ismini "products" verirsin.
 */
export const dataProvider: DataProvider = {
  async getList(params) {
    return unwrap(await getResourceList(params.resource, params.pagination));
  },
  async getOne(params) {
